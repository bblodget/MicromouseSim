...
web browser.  It exposes a JavaScript Mouse API for controlling
a simulated mouse running in a simulated maze.  You can type
your mouse driver code directly in a textbox on the web page.
...
use Firefox's Firebug extension for debugging.
...
[[http://loafer.freeshell.org/Micromouse ]]

## Download

You can download the latest source via

git clone  bla_bla_bla
